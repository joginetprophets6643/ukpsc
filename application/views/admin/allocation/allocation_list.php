<div class="datalist">
    ...
    <!-- <?php// echo form_open_multipart(base_url('admin/allocation_admin/save'), 'id="xin-form"  class="form-horizontal"'); ?> -->
        <table id="na_datatable" class="table table-bordered table-hover" style="border-collapse: collapse !important;">
            <thead>
                <tr>
                    <th>S.No.</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- <input type="submit" title="Save"
                            ...
                            style="margin-top: 8px !important; padding:3% !important;  font-weight: 100 !important; font-size: 15px;"/> -->
                            <button onclick="formdataSubmit(<?php echo $i; ?>)"> Submit</button>
