   ...
   <table id="example1" class="table table-bordered table-hover" >
      <thead>
         <tr>
            ...
            <th>Allocated No of Student</th>
            <!-- <th>Bank Details</th> -->
            <!-- <th>Date of Apply</th> -->
            <!-- <th>Documents</th> -->

            <!-- <th width="120"><?php// trans('action') ?></th> -->
         </tr>
      </thead>
      <tbody>
      ...
      ?>
         ...
         <tr>
           ...
           <!--  <td>
                <?php //get_exam_name($row['exam_name']) ?>        
            </td> -->
            <td>  
         ...
         <input type="text" class="form-control"  value="<?php echo $can; ?>" name="no of student" id="no of student">
          ...
          <?php }  if ($admin_role_id == 5 )  { ?>
            <a href="<?php// base_url("admin/consent_letter/add_remark_concent/" . $row['id']); ?>" title="Add Action" class="btn btn-warning btn-xs mr5"  style="margin-top: 8px !important; padding:3% !important;  font-weight: 100 !important; font-size: 15px;">
            <label>Save </label>
             </a>
