    ...
    <section class="content">
             ...
             <div class="row">
                 <div class="col-md-4">
                    <div class="form-group ">
                                 ...
                                 <div class="col-md-4">
                                <div class="form-group">
                                    <label for="firstname" class="col-md-12 control-label"><?= trans('firstname') ?><span style="color:red;font-weight:bold">*</span></label>
     ...
     <input type="text"  name="username"  class="form-control" id="username" placeholder="Enter Username">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                                    <label for="phone_no" class="col-md-12 control-label"><?= trans('phone_no') ?><span style="color:red;font-weight:bold">*</span></label>
                                        <input type="text" maxlength="15"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  name="phone_no" class="form-control" id="phone_no" placeholder="Enter Phone Number">
                                    </div>
                                </div>
                    <div class="col-md-4">
                       <div class="form-group">
                                    <label for="mobile_no" class="col-md-12 control-label"><?= trans('mobile_no') ?><span style="color:red;font-weight:bold">*</span></label>
                ...
                <div class="row">
                      <div class="col-md-4">
                    <div class="form-group">
                                    <label for="idproof" class="col-md-12 control-label"><?= trans('idproof') ?><span style="color:red;font-weight:bold">*</span></label>
                    ...
                    <div class="col-md-4">
                    <div class="form-group">
                                    <label for="idproof_no" class="col-md-12 control-label">ID Proof Number<span style="color:red;font-weight:bold">*</span></label>

                                    
                                        <input type="text"  name="idproof_no" class="form-control" id="idproof_no" placeholder="Enter ID Proof Number">
                                    </div>
                                </div>
                     <div class="col-md-4">
                    <div class="form-group">
                                    <label for="state" class="col-md-12 control-label"><?= trans('state') ?><span style="color:red;font-weight:bold">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="form-group " >
                                    <label for="district" class="col-md-12 control-label"><?= trans('district') ?><span style="color:red;font-weight:bold">*</span></label>
    ...
    <input type="password" name="password" class="form-control" id="password" placeholder="Enter Password ">
          ...
          <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <input type="submit" name="submit" value="<?= trans('add_admin') ?>" class="btn btn-primary">
                                    </div>
                                </div>
