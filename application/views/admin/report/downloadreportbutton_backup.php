      ...
      <div class="row mt-4">
        ...
        <div class="col-md-4">
                    <div class="card bg-warning">
                        <div class="card-body">
                        <div class="table-responsive">
                        <table class="table table-striped table-bordered " id="consentNotRecieve">
                                    <thead>
                                        <tr>
                                            <th>S.No</th>
                                            <th>School Registration No.  </th>
        ...
        <div class="col-md-4">
                    <div class="card bg-info">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="attendanceMaster" class="table table-bordered table-striped" style="border-collapse: collapse !important;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
