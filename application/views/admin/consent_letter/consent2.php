         ...
         <div class="input-text">
            <div class="input-div">
             ...
             <label for="mobile_no" class="col-sm- control-label">Centre Superintendent Name <br>(केंद्र अधीक्षक का नाम)</label>
              <input type="text" name="super_name" value="<?php if (isset($user['super_name']) ) {
              ...
              <input type="text" name="super_design" id="super_design"  value="<?php if (isset($user['super_design'])) {
                                    echo $user['super_design'];
                                } ?>" >
             
            <div class="input-div">
            <label >Mobile No.<br> (मोबाइल नंबर)</label>
              <input type="text" name="super_mobile" maxlength="10" value="<?php if (isset($user['super_mobile'])) {
             ...
             <label for="district" class="col-md-12 control-label">Email ID<br> (ईमेल आईडी)</label>
              <input type="text" value="<?php if (isset($user['super_email'])) {
            ...
            <label for="district" class="col-md-12 control-label">Whats App No.<br> (व्हाट्सएप नंबर)</label>
              <input type="text" name="super_whatspp"  value="<?php if (isset($user['super_whatspp'])) {
