        ...
        <div class="main active">
          ...
          <div class="input-text">
            <div class="input-div" >
              ...
              <input type="text"  name="school_name" class="color"  id="school_name"   value="<?php echo $admin['school_name'] ?>">
          </div>
            <div class="input-div">
                  <label>Address (पता)</label>
               <input type="text" name="address" id="address" class="color"    require value="<?php echo $admin['address'] ?>">
