                    ...
                    <div class="d-flex">
                        ...
                        <div class="" style="margin-left:20px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date_exam[]" class="form-control date_disable" id="date_exam"
                        ...
                        <div class="">
                            ...
                            <div class="form-group change">
                                ...
                                <a class="btn btn-success add-more"
                                    style="margin-top: 0px;height:37px; padding: 3px 8px; text-align: center; color: white; text-overflow: initial; font-weight: bold; font-size: 22px;">+
                                </a>
