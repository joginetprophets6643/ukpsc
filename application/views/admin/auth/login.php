...
<style>a {  color: #fff;  text-decoration: none;  background-color: transparent;  -webkit-text-decoration-skip: objects;}
    * {
           ...
           <img src="<?= base_url(); ?>assets/dist/img/ukpsc_logo.png" />
            ...
            <div class="card-body login-card-body">   
                ...
                <div class="row">
                   ...
                   <div class="" style="color:#fff; width:670px"><img style="border-radius: 20px 0 0px 20px;" src="<?= base_url(); ?>assets/dist/img/side_bg2.jpg" /></div>
                    <div class="column" style="background-color: #71024f; border-radius: 0 20px 20px 0; color:#fff; width:430px">
