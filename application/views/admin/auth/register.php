                ...
                <div class="row">
                    ...
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <input type="text" name="school_name" maxlength="300" style="text-transform:capitalize;"
                            id="school_namec" value="<?php if (old('school_name') != " ") {
                    ...
                    <div class="form-group has-feedback col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div style="margin-top: -45px; float: right;margin-right: -168px;"> <i
...
$('#principal_name,#school_name').keydown(function(er) {
    if (er.altKey || er.ctrlKey) {
        ...
        if (!((key == 8) || (key == 9) || (key == 32) || (key == 46) || (key == 189) || (key == 190) || (key >=
                65 && key <= 90))) {
            er.preventDefault();
